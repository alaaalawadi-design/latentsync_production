...
class ProjectManager:
    def __init__(self, base_dir: Path, models_dir: Path, device="cuda", seed=1247, guidance_scale=2.0):
        ...
        self.ref_video_path = "data/ref_videos/ref_video.mp4"
        # self.data_dir / "ref_videos" / "1.mp4"
