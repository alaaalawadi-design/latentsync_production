...
if __name__ == "__main__":
    ...
    ref_video_path = "/media/administrator/disk_2/GenAI2/latentsync_production/cysync/data/ref_videos/ref_video.mp4"

    video_frames = video_processor.affine_transform_video(ref_video_path)
    write_video("outputaffine.mp4", video_frames, fps=25)
