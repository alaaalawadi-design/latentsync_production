...
# latentsync/utils/
def load_fixed_mask(resolution: int, mask_image_path="/media/administrator/disk_2/GenAI2/latentsync_production/cysync/latentsync/utils/mask.png") -> torch.Tensor:
...
class AlignRestore(object):
    ...
    def restore_img(self, input_img, face, affine_matrix):
        ...
        # Step 2: Warp Face Back to Original Coordinates
